...
from dataset.dataset_spr import SprData
from vin_utility.utils import *
from models.vanilla_vin import VIN
...
if __name__ == '__main__':
    ...
    trainset = SprData(config.datadir, config.imsize, mode='local', annotation='human', train=True)
    testset = SprData(config.datadir, config.imsize, mode='local', annotation='human', train=False)
